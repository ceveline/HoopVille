    ...
    <div class="background">
        <div class="content">
            ...
            <div class="review-header">
                <p class="reviewer-info"><strong>Written by:
                    </strong><?php echo $data['userDetails']['first_name'] . ' ' . $data['userDetails']['last_name']; ?>
            ...
            <div class="info-details">
                <a href="/Profile/infoDetails/<?php echo $data['userDetails']['profile_id']; ?>">View Profile</a>
            </div>
            ...
            <div class="button-group">
                ...
                <a href="/Review/deleteReview/<?php echo $data['review']->review_id; ?>" class="delete-button">Delete
                    Review</a>
            </div>
        </div>
    </div>

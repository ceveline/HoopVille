...
<head>
    ...
    <style>
        ...
        .inline-inputs input[type="text"] {
            flex: 1;
            /* Take up equal space as label */
            max-width: 150px;
            /* Set maximum width for input */
            height: 32px;
            /* Set input height */
            border-radius: 5px;
            /* Add border radius */
        ...
        @media (max-width: 768px) {
            ...
            .camps {
                order: 1;
                /* Set the order to display below Profile on small screens */
            }
        }
